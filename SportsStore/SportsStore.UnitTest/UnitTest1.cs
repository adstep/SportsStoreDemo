...
namespace SportsStore.UnitTest
{
    ...
    public class UnitTest1
    {
        ...
        {
            // Arange - create some test products
        ...
        public void Cannot_Checkout_Empty_Cart()
        {
            ...
            // Assert - check that the order hasn't been passed on tot he processor
            mock.Verify(m => m.ProcessOrder(It.IsAny<Cart>(), It.IsAny<ShippingDetails>()), Times.Never);
            // Assert - check that hte method is returning the default view
        ...
        {
            // Arrange - create a mock order proessor
            Mock<IOrderProcessor> mock = new Mock<IOrderProcessor>();
            ...
            // Assert - chec that the order hasn't been passed on to the processor
